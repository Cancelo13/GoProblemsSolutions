 ...
 */
export function getFirstCard(cards){
    let [card] = cards;
    return card;
};
 ...
 */
export function getSecondCard(cards){
 ...
 */
export function swapTwoCards(cards){
    let [firstCard, secondCard] = cards;
 ...
 */
export function shiftThreeCardsAround(cards){
    let [firstCard, secondCard, thirdCard] = cards;
    cards = [secondCard, thirdCard, firstCard];
    return cards;
}
...
export function swapNamedPile(piles){
    ...
    piles = {chosen: disregarded, disregarded: chosen};
    return piles;
}
